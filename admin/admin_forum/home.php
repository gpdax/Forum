...
function ()
{
$('#load_tweets4').load('admin_sidebar.php') ;
}, 10000); //refresh div every 10000 milliseconds or 10 seconds
   	...
   	<?php  include('sidebar.php'); ?> 
			...
			<div class="col-md-9">
					<div class="jumbotron alert-success">
										...
										<li class="active"><a href="home.php"><img src="../images/windows.png" width="40" height="40" />WINDOWS</a></li>
