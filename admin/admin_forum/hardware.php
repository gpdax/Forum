...
function ()
{
$('#load_tweets1').load('feed_hardware.php') ;
			...
			<div class="col-md-9">
					<div class="jumbotron alert-success">
                                        ...
                                        <li  ><a href="linux.php"><img src="../images/linux.png" width="40" height="40" /> LINUX</a></li>
									 	...
									 	<li class="active"><a href="hardware.php"><img src="../images/hardware.png" width="40" height="40" /> HARDWARE</a></li>
										</ul>
                                        	 
                                             
						<div id="load_tweets1"> 
							 <?php  include('feed_hardware.php');  ?>
                             </div>
