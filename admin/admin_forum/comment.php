    ...
    <center>
		...
		while ($row_query_replies_ctr = $query_replies_ctr->fetch()) 
        {
            $ctr_replies=$row_query_replies_ctr['replies_ctr']+1;
                ...
                $conn->query("insert into repz (member_id,date_replied,reply_content,comment_id,reply_image,access) values ('$session_id','$date_replied','$reply_content','$comment_id','$repz_location','Admin')");
		...
		while ($row_query_threads_ctr = $query_threads_ctr->fetch()) 
        {
            $ctr_threads=$row_query_threads_ctr['threads_ctr']+1;
                ...
                $conn->query("insert into comment (member_id,date_commented,comment_content,post_id,comment_image,access) values ('$session_id','$date_comment','$comment_content','$post_idx','$location','Admin')");
